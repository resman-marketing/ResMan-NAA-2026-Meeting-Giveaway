...
<section class="alt">
  <div class="wrap">
    ...
    <div class="faq">
      ...
      <div class="q"><button>When should I share the Party Link? <span class="pm">+</span></button><div class="ans"><p><b>Only after the meeting is fully complete</b> &mdash; never before or during. Once the conversation wraps, pull it up and share it with them on the spot.</p></div></div>
